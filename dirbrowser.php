...
if(!dirbrowser_isrootdir($r_dir)) {
  echo "<a href='dirbrowser.php?dir=".urlencode(substr($r_dir,0,strrpos($r_dir,"/")))."&amp;hilitedir=".urlencode($r_hilitedir)."'>[..]</a><br>";
}

$files=array();
if($dirarray = dirbrowser_scandir($r_dir)) {
