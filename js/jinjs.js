...
require.define("/environment.js",function(require,module,exports,__dirname,__filename,process){(function(){
...
require.define("/parser.js",function(require,module,exports,__dirname,__filename,process){(function(){
...
require.define("/lexer.js",function(require,module,exports,__dirname,__filename,process){/**
 *  A Lexer.
 *
...
require.define("/nodes.js",function(require,module,exports,__dirname,__filename,process){(function(){
  ...
  NodeAutoEscapeDummy = (function(_super){
    NodeAutoEscapeDummy.displayName = 'NodeAutoEscapeDummy';
    var prototype = __extends(NodeAutoEscapeDummy, _super).prototype, constructor = NodeAutoEscapeDummy;
    NodeAutoEscapeDummy.tag = 'autoescape';
    NodeAutoEscapeDummy.until = 'endautoescape';
    function NodeAutoEscapeDummy(specs){
      NodeAutoEscapeDummy.superclass.apply(this, arguments);
    }
    prototype.compile = (function(){
      function compile(opts, ctx){
        var res;
...
require.define("/expression.js",function(require,module,exports,__dirname,__filename,process){module.exports = (function(){
  /*
  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_expression() {
        ...
        if (result0 !== null) {
          result1 = parse_ternary_operator();
          if (result1 !== null) {
            result2 = parse_space();
      ...
      function parse_ternary_operator() {
        ...
        if (result0 !== null) {
          result1 = parse_QUESTION_MARK();
          if (result1 !== null) {
            result2 = parse_ternary_operator();
            if (result2 !== null) {
              result3 = parse_COLON();
              if (result3 !== null) {
                result4 = parse_ternary_operator();
                if (result4 !== null) {
        ...
        if (result0 !== null) {
          result0 = (function(offset, p, e1, e2) {
          return "(" + p + " ? " + e1 + " : " + e2 + ")";
      ...
      function parse_operation() {
        ...
        if (result0 === null) {
          pos0 = pos;
          pos1 = pos;
          result0 = parse_filter_expression();
          if (result0 !== null) {
            result1 = parse_binary();
            if (result1 !== null) {
      ...
      function parse_filter_expression() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, expr, f) {
      ...
      function parse_filter_literal() {
        ...
        result0 = parse_PIPE();
        if (result0 !== null) {
          result1 = parse_filter_name();
          if (result1 !== null) {
            result2 = parse_LPAREN();
            if (result2 !== null) {
              result3 = parse_call_arguments();
      ...
      function parse_function_call_rec() {
        ...
        if (result0 !== null) {
          result1 = parse_function_call_rec();
          if (result1 !== null) {
            result0 = [result0, result1];
          } else {
            result0 = null;
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result1 = parse_DOT();
            if (result1 !== null) {
              result2 = parse_ic_member_expression_rec();
              if (result2 !== null) {
                result0 = [result0, result1, result2];
              } else {
                result0 = null;
          ...
          if (result0 !== null) {
            result0 = (function(offset, f, member) {
            return f + "." + member;
          })(pos0, result0[0], result0[2]);
          }
          if (result0 === null) {
          ...
          if (result0 === null) {
            ...
            result0 = parse_function_call();
            if (result0 !== null) {
              result1 = parse_array_indexing_rec();
              if (result1 !== null) {
                result0 = [result0, result1];
              } else {
                result0 = null;
      ...
      function parse_array_index() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, contents) {
          return "[" + contents + "]";
        })(pos0, result0[1]);
        }
        if (result0 === null) {
      ...
      function parse_array_indexing_rec() {
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, a, member) {
            return a + "." + member;
          })(pos0, result0[0], result0[2]);
          }
          if (result0 === null) {
      ...
      function parse_member_expression() {
        ...
        pos0 = pos;
        pos1 = pos;
        result0 = parse_ooc_primary_expression();
        if (result0 !== null) {
          result1 = parse_DOT();
          if (result1 !== null) {
            result2 = parse_ic_member_expression_rec();
      ...
      function parse_ooc_primary_expression() {
        ...
        if (result0 === null) {
          pos0 = pos;
          result0 = parse_primary_identifier();
          if (result0 !== null) {
      ...
      function parse_ic_member_expression_rec() {
        ...
        pos0 = pos;
        pos1 = pos;
        result0 = parse_ic_member_expression();
        if (result0 !== null) {
          result1 = parse_DOT();
          if (result1 !== null) {
            result2 = parse_ic_member_expression_rec();
        ...
        if (result0 !== null) {
          result0 = (function(offset, xp, rec) {
          return xp + "" + rec;
        })(pos0, result0[0], result0[2]);
        }
        if (result0 === null) {
      ...
      function parse_ic_member_expression() {
        ...
        pos0 = pos;
        pos1 = pos;
        result0 = parse_ic_primary_expression();
        if (result0 !== null) {
          result1 = parse_DOT();
          if (result1 !== null) {
            result2 = parse_ic_member_expression();
            if (result2 !== null) {
              result0 = [result0, result1, result2];
            } else {
              result0 = null;
      ...
      function parse_object_literal() {
        ...
        if (result0 !== null) {
          result1 = parse_object_arguments();
          result1 = result1 !== null ? result1 : "";
          if (result1 !== null) {
      ...
      function parse_object_arguments() {
        ...
        pos0 = pos;
        pos1 = pos;
        result0 = parse_object_argument();
        if (result0 !== null) {
          result1 = parse_COMMA();
          if (result1 !== null) {
            result2 = parse_object_arguments();
            if (result2 !== null) {
              result0 = [result0, result1, result2];
            } else {
              result0 = null;
      ...
      function parse_filter_name() {
        ...
        pos0 = pos;
        result0 = parse_filter_identifier();
        if (result0 !== null) {
          result0 = (function(offset, ident) {
      ...
      function parse_filter_identifier() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, first, next) {
      ...
      function parse_string() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            result2 = parse_single_quoted_contents();
            result2 = result2 !== null ? result2 : "";
            if (result2 !== null) {
              if (input.charCodeAt(pos) === 39) {
                result3 = "'";
        ...
        if (result0 !== null) {
          result0 = (function(offset, sglcnt) {
          return "'" + sglcnt + "'";
        })(pos0, result0[2]);
        }
        if (result0 === null) {
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            ...
            if (result1 !== null) {
              result2 = parse_double_quoted_contents();
              result2 = result2 !== null ? result2 : "";
              if (result2 !== null) {
                if (input.charCodeAt(pos) === 34) {
                  result3 = "\"";
          ...
          if (result0 !== null) {
            result0 = (function(offset, dblcnt) {
            return "\"" + dblcnt + "\"";
          })(pos0, result0[2]);
          }
          if (result0 === null) {
      ...
      function parse_regexp() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, regcnt, modifs) {
      ...
      function parse_single_quoted_contents() {
        ...
        pos0 = pos;
        pos1 = pos;
        result0 = parse_single_quoted_terminal();
        if (result0 !== null) {
          result1 = parse_single_quoted_contents();
          if (result1 !== null) {
            result0 = [result0, result1];
          } else {
            result0 = null;
      ...
      function parse_double_quoted_contents() {
        ...
        pos0 = pos;
        pos1 = pos;
        result0 = parse_double_quoted_terminal();
        if (result0 !== null) {
          result1 = parse_double_quoted_contents();
          if (result1 !== null) {
            result0 = [result0, result1];
          } else {
            result0 = null;
      ...
      function parse_regexp_contents() {
        ...
        pos0 = pos;
        pos1 = pos;
        result0 = parse_regexp_terminal();
        if (result0 !== null) {
          result1 = parse_regexp_contents();
          if (result1 !== null) {
            result0 = [result0, result1];
          } else {
            result0 = null;
      ...
      function parse_post_unary() {
        ...
        result0 = result0 !== null ? result0 : "";
        if (result0 !== null) {
          result1 = parse_POST_UNARY_OPERATOR();
          if (result1 !== null) {
            result2 = parse_space();
            result2 = result2 !== null ? result2 : "";
            if (result2 !== null) {
      ...
      function parse_binary() {
        ...
        result0 = result0 !== null ? result0 : "";
        if (result0 !== null) {
          result1 = parse_TEXT_BINARY_OPERATOR();
          if (result1 !== null) {
            result2 = parse_space();
            result2 = result2 !== null ? result2 : "";
            if (result2 !== null) {
      ...
      function parse_tag_for() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, key, exp) {
          return {
          key: key,
          condition: exp
        };
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, key, value, exp) {
            return {
            key: key,
            value: value,
            condition: exp
      ...
      function parse_tag_let() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, variable_name, expression) {
          return {
      ...
      function parse_tag_macro() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            result2 = parse_macro_call_arguments();
            result2 = result2 !== null ? result2 : "";
            if (result2 !== null) {
        ...
        if (result0 !== null) {
          result0 = (function(offset, function_name, args) {
          return {
          function_name: function_name,
          args: args == '' ? [] : args
        };
      ...
      function parse_macro_call_arguments() {
        ...
        if (result0 !== null) {
          ...
          if (result2 !== null) {
            result2 = (function(offset, arg) { return arg; })(pos2, result2[1]);
          }
          if (result2 === null) {
            pos = pos2;
          }
        ...
        if (result0 !== null) {
          result0 = (function(offset, first, other_args) {
          var arg, res;
      ...
      function parse_tag_block() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, first_letter, next_letters) {
      ...
      function parse_tag_import() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, exp, args, ctx) {
          return {
          template: exp,
          variables: args,
          with_context: ctx !== ""
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, exp, id, ctx) {
            return {
            template: exp,
            as_name: id,
            with_context: ctx !== ""
...
require.define("/module_template.js",function(require,module,exports,__dirname,__filename,process){var _require = function (mod) { 
...
var _fref = $$.utils || [], _prev_loop = $$.loop, _prev_key = $$['fname'], _prev_value = $$['fn'], k = null, v = null, i = 0, l = 0, x = null, last_v = null, last_k = null;
$$.loop = { };
if (_fref instanceof Array) {
    l = _fref.length;
    for (i = 0; i < l; i++) {
...
if ($$.loop.index == undefined) {
    
}
$$.loop = _prev_loop; $$['fname'] = _prev_key; $$['fn'] = _prev_value;
})();_res += '\n';(function() {
var _fref = $$.filters_used || [], _prev_loop = $$.loop, _prev_key = $$['fn_name'], _prev_value = $$['decl'], k = null, v = null, i = 0, l = 0, x = null, last_v = null, last_k = null;
$$.loop = { };
if (_fref instanceof Array) {
    l = _fref.length;
    for (i = 0; i < l; i++) {
        ...
        $$.loop.index0 = i;
        $$.loop.index = i + 1;
        $$['fn_name'] = _fref[i]; $$['decl'] = i;
        _res += ((_ref = $$.decl) !== undefined && _ref !== null ? _ref : '').toString();_res += '\n';
    }
} else {
    $$.loop = { first: true, last: false };
    l = Object.keys(_fref).length;
...
$$.loop = _prev_loop; $$['fn_name'] = _prev_key; $$['decl'] = _prev_value;
})();_res += '\n';if ($$.blocks) {
    _res += '// Start Block Definitions\n\n';(function() {
var _fref = $$.blocks || [], _prev_loop = $$.loop, _prev_key = $$['name'], _prev_value = $$['contents'], k = null, v = null, i = 0, l = 0, x = null, last_v = null, last_k = null;
$$.loop = { };
if (_fref instanceof Array) {
    l = _fref.length;
    for (i = 0; i < l; i++) {
...
$$.loop = _prev_loop; $$['name'] = _prev_key; $$['contents'] = _prev_value;
...
require.define("/utils.js",function(require,module,exports,__dirname,__filename,process){(function(){
  function __in(obj, container){
    if (obj instanceof Array) {
      return __indexOf.call(container, obj) > -1;
    }
...
require.define("/filters.js",function(require,module,exports,__dirname,__filename,process){/**
...
require.define("/helpers.js",function(require,module,exports,__dirname,__filename,process){(function(){
...
require.define("/express.js",function(require,module,exports,__dirname,__filename,process){(function(){
...
require.define("/main.js",function(require,module,exports,__dirname,__filename,process){(function(){
  ...
  if (process.browser) {
    window.jinjs = defaultEnvironment;
  }
